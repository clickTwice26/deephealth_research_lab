...
export default function Hero() {
  ...
  return (
    <section ref={containerRef} id="home" className="relative min-h-[calc(100vh-4rem)] flex items-start overflow-hidden bg-white dark:bg-gray-950 pt-36 lg:pt-40 pb-20 transition-colors duration-300 scroll-mt-24">
      {/* Background Grid */}
