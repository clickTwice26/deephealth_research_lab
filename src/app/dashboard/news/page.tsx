    ...
    return (
        <div className="space-y-6 max-w-full mx-auto">
            ...
            <Modal
                ...
                title={editingId ? 'Edit News Item' : 'Publish New Update'}
                type="default"
            >
                        ...
                        <AnimatePresence mode="popLayout">
                            {news.map((item) => (
                                <motion.div
                                    ...
                                    className={`bg-white dark:bg-gray-900 rounded-xl p-5 border shadow-sm hover:shadow-md transition-all group border-gray-200 dark:border-gray-800`}
                                >
